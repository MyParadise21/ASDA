...
def get_parser():
    parser = argparse.ArgumentParser(
        description="extract ASDA features for downstream tasks"
    )
    ...
    parser.add_argument('--mode', type=str, choices=['pretrain', 'finetune'], required=True, 
                        help='Specifies the mode of the model: "pretrain" for ASDA pre-training, "finetune" for ASDA fine-tuning.')
    return parser
