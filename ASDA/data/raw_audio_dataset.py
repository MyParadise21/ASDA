...
class FileAudioDataset(RawAudioDataset):
    ...
    def __getitem__(self, index):
        ...
        if self.wav2fbank:
            ...
            # global normalization for fsd50k
            if self.fsd50k_eval:
                self.norm_mean = -7.966
                self.norm_std = 4.753
            ...
            if self.fsd50k_eval:
                ...
                if diff > 0:
                    ...
                    offset = torch.randint(0, n_frames - self.target_length + 1, (1,)).item()
                    feats = feats[:, offset:offset + self.target_length, :]
