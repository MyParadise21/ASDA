...
def get_parser():
    parser = argparse.ArgumentParser(description="Use fine-tuned ASDA for inference in Audioset-eval")
    ...
    parser.add_argument('--target_length', type=int, help='Target length of Mel spectrogram in time dimension', default=1024)
    ...
    parser.add_argument('--ap_log_path', type=str, default='ASDA/ap_log.txt', help='Path to save the AP values log')
    return parser
